  ...
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "48px 24px", fontFamily: "'DM Sans', sans-serif", color: "#0f0d0a" }}>
      ...
      <div style={{ lineHeight: 1.9, fontSize: 15 }}>
        ...
        <S title="14. Termination" zh="终止">Joker may suspend or terminate any account that violates these terms without prior notice. Users may close their account at any time by contacting support@joker.pub.</S>
        ...
        <div style={{ marginTop: 48, padding: 32, background: "#0f0d0a", color: "#f5f0e8", textAlign: "center" }}>
          ...
          <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, color: "#6b6560", lineHeight: 1.8 }}>Open Access · Community Review · Author-Owned Copyright<br/>Questions? <span style={{ color: "#c1121f" }}>support@joker.pub</span></p>
        </div>
